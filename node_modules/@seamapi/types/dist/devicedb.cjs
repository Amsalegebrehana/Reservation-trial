...
var device_model_v0 = zod.z.object({
  ...
  manufacturer_model_id: zod.z.string(),
  connection_type: zod.z.enum(["wifi", "zwave", "zigbee", "unknown"]),
  support_level: zod.z.enum(["live", "beta", "unsupported"]),
  brand: zod.z.string(),
  icon_url: zod.z.string(),
  seam_device_model_page_url: zod.z.string()
});
